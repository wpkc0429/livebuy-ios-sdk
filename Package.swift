...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/ariesweng/livebuy-ios-sdk/releases/download/v4.6.2/LivebuySDK.xcframework.zip",
            checksum: "7713f340ee4afe381206982776f1fabc009c6be13f6898b646c7f97ba98e9e22"
        ),
