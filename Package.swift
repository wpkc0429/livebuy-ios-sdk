...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/ariesweng/livebuy-ios-sdk/releases/download/v4.7.0/LivebuySDK.xcframework.zip",
            checksum: "23bd4c4e3acbb0ec1b0365ee3f70f4c6ef719fec0905c9a1e66e42f9be1ca996"
        ),
