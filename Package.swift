...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/ariesweng/livebuy-ios-sdk/releases/download/v4.13.1/LivebuySDK.xcframework.zip",
            checksum: "ac44d208dd82131db3fe980387e8c32a8a03a6bae103bafa4153e1ecfeed121d"
        ),
