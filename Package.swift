...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/ariesweng/livebuy-ios-sdk/releases/download/v4.15.0/LivebuySDK.xcframework.zip",
            checksum: "c787910ece8a587c8a53a9ebad8ad6f1603db38a8b05b2e7b8ff012fb2a8bf29"
        ),
